...
def create_snap():
    ...
    response = rdsclient.create_db_snapshot(
...
def mail_response():
    ...
    sender = 'ec2-user@c7n02.somedomain.com'
...
with open('/home/ec2-user/databases/adhocclone-manifest.yml') as manifest:

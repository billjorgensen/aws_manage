#!/usr/bin/env python3
#
# Title: sts_exportcreds.py
#
# Description: sts_exportcreds.py is used in tandem with okta_aws to populate a hidden text file
...
#
# Usage: sts_exportcreds.py [ account profile ]
#        sts_exportcreds.py -h for help
#
# Prereqs:
...
parser.add_argument('account', help='declare the AWS account as an argument, either sandbox, nonprod, or prod',

...
#
# Description: ec2_startstop.py sources a yaml file (ec2_ids.yml) with a list of
# ec2 instance ids. it uses a boto3 api call to either start or stop the list of
# ec2 ids...
#
# Example ec2_ids.yml
# ---
...
parser = argparse.ArgumentParser(
    description='Script to stop or start EC2 instance ids in the yaml file ec2_ids.yml')
